...
//                .getSpecialization().getTrainingName()); // wrong password exception
        ...
        System.out.println(trainingService.getTrainingsByTraineeAndTrainingTypesForTrainee(List.of(trainingType2), trainee4_Username, trainee4_Password));
        System.out.println("List of trainings fo trainer");
        System.out.println(trainingService.getTrainingsByTrainerAndTrainingTypesForTrainer(List.of(trainingType2), trainer2_Username, trainer2_Password));
        System.out.println("List of trainers fo trainee");
        System.out.println(trainerService.getAllTrainersAvalibleForTrainee(trainee6, trainee4_Username, trainee4_Password));
        System.out.println(trainerService.getAllTrainersAvalibleForTrainee(trainee6, trainee6_Username, trainee6_Password));
